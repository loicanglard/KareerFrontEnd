...
const steps = [
  {
    ...
    desc: "Répondez à un entretien IA qui construit automatiquement votre profil académique et professionnel.",
    bullets: [
      "Interface intuitive",
      "Sections complètes (formation, expérience, compétences)",
      "Questions précises",
    ],
    image: stepImages[0],
    imageAlt: "Créez votre profil",
  },
  {
    title: "Générez Vos Candidatures",
    desc: "Obtenez un CV et une lettre de motivation adaptés à chaque offre et entièrement personnalisés en quelques secondes.",
    bullets: [
      "Entretien de motivation",
      "Modèles adaptés aux secteurs",
      "Mise en forme automatique en 1 clic",
    ],
    image: stepImages[1],
    imageAlt: "Générez vos candidatures",
  },
  {
...
export default function LandingEtudiants() {
  return (
    <div className="bg-gradient-to-b from-white via-gray-50 to-blue-50 min-h-screen">
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto flex flex-col items-center text-center">
          ...
          >
            Démarquez-Vous. <span className="text-cyan-300">Trouvez Votre Voie.</span>
          </h1>
          <p
